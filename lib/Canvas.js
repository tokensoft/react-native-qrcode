...
var Canvas = createReactClass({
    ...
    render() {
        ...
        var qrCodeStyle = '<meta name="viewport" content="width=device-width, initial-scale=1"> <style>*{width:100%;height:100%;resize:contain;margin:0; padding:0;}';
        return (
            <View style={this.props.style}>
                <WebView
                    ...
                    source={{html:
                        qrCodeStyle +
                        "canvas{transform:translateZ(0);}</style><canvas></canvas><script>var canvas = document.querySelector('canvas');(" +
                        renderString +
                        ").call(" +
                        contextString +
                        ", canvas);</script>"
